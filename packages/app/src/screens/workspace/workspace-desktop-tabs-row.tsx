...
const CHANGES_ICON = <ThemedFileDiff uniProps={mutedHeaderIconMapping} />;
const FILES_ICON = <ThemedFolderTree uniProps={mutedHeaderIconMapping} />;
const PULL_REQUEST_ICON = <ThemedGitPullRequest uniProps={mutedHeaderIconMapping} />;
...
const styles = StyleSheet.create((theme) => ({
  ...
  inlineAddActionButton: {
    // Fork: control geometry scales with the UI font size, so this is not a fixed height.
