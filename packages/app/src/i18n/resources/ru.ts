...
export const ru: TranslationResources = {
  ...
  agentStream: {
    ...
    execution: {
      expand: "Показать детали выполнения ({{count}})",
      collapse: "Скрыть детали выполнения",
    },
  ...
  message: {
    ...
    actions: {
      ...
      copyConclusion: "Скопировать вывод",
      copiedConclusion: "Вывод скопирован",
      copyFull: "Скопировать весь ответ",
      copiedFull: "Весь ответ скопирован",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markReady: "Готово к проверке",
        markDoneAccessibility: "Отметить рабочую область как готовую",
        markReadyAccessibility: "Вернуть рабочую область в готовые к проверке",
  ...
  desktop: {
    ...
    daemon: {
      ...
      versionSync: {
        managedHint:
          "Этот daemon запущен из старой сборки Desktop. Синхронизируйте и перезапустите его с версией из этого приложения.",
        managedPausedHint:
          "Включите управление встроенным daemon, затем синхронизируйте и перезапустите его.",
        externalHint:
          "Этот daemon управляется вне Desktop. Обновите внешний сервис daemon и перезапустите его.",
        action: "Синхронизировать и перезапустить",
        syncing: "Синхронизация...",
        failed: "Не удалось синхронизировать daemon: {{message}}",
        stillMismatched: "Daemon перезапущен, но по-прежнему сообщает другую версию.",
      },
  ...
  settings: {
    ...
    serverMigration: {
      ...
      importDescription: "Merge a server backup without replacing existing servers.",
