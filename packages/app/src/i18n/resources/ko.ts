...
export const ko: TranslationResources = {
  common: {
    ...
    errors: {
      ...
      ambiguousFile:
        "{{token}}과(와) 일치하는 파일이 여러 개입니다. 에이전트에게 전체 경로를 요청하세요",
  ...
  composer: {
    ...
    input: {
      ...
      voiceInput: "받아쓰기",
      textInput: "텍스트",
      switchToVoiceInput: "음성 입력으로 전환",
      switchToTextInput: "텍스트 입력으로 전환",
      tapToDictate: "탭하여 받아쓰기",
      addAttachment: "첨부 추가",
  ...
  message: {
    actions: {
      ...
      copyTurn: "턴 복사",
      copyMessage: "메시지 복사",
      copyConclusion: "결론 복사",
      copiedConclusion: "결론이 복사되었습니다",
      copyFull: "전체 응답 복사",
      copiedFull: "전체 응답이 복사되었습니다",
      forkMenu: "여기에서 채팅 분기",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        rename: "워크스페이스 이름 변경",
        markDone: "완료로 표시",
        markReady: "검토 준비로 되돌리기",
        markDoneAccessibility: "워크스페이스를 완료로 표시",
        markReadyAccessibility: "워크스페이스를 검토 준비로 표시",
        pin: "상단에 고정",
        unpin: "고정 해제",
        archive: "보관",
      ...
      confirmations: {
        archiveReadyTitle: "검토 대기 중인 워크스페이스를 보관할까요?",
        archiveReadyMessage:
          "워크스페이스를 열어도 완료로 표시되지 않습니다. 검토 대기 목록에서 정말 제거하려는 경우에만 보관하세요.",
        archiveReadyConfirm: "보관",
        archiveReadyCancel: "검토 대기 유지",
  ...
  settings: {
    ...
    serverMigration: {
      ...
      copyAction: "복사",
      copied: "복사됨",
      securityHint: "저장된 비밀번호와 페어링 키가 포함됩니다. 외부에 공유하지 마세요.",
      importTitle: "서버 가져오기",
      importDescription: "기존 서버를 대체하지 않고 서버 백업을 이 기기에 병합합니다.",
      importHelp: "Paseo 서버 JSON 또는 한 줄에 하나씩 Relay 페어링 링크를 붙여넣으세요.",
      placeholder: "서버 JSON 또는 Relay 링크를 한 줄에 하나씩 붙여넣기",
      importAction: "가져오기",
      importing: "가져오는 중...",
      invalid: "잘못된 서버 데이터",
    },
    ...
    host: {
      ...
      pairDevices: {
        ...
        updateRequired: "페어링 링크를 가져오려면 이 호스트를 업데이트하세요",
      },
      orchestration: {
        title: "오케스트레이션",
