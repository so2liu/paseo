...
export const ptBR: TranslationResources = {
  common: {
    ...
    errors: {
      ...
      ambiguousFile: "Vários arquivos correspondem a {{token}}; peça ao agente o caminho completo",
  ...
  agentStream: {
    ...
    execution: {
      expand: "Mostrar detalhes da execução ({{count}})",
      collapse: "Ocultar detalhes da execução",
    },
  ...
  message: {
    ...
    actions: {
      ...
      copyConclusion: "Copiar conclusão",
      copiedConclusion: "Conclusão copiada",
      copyFull: "Copiar resposta completa",
      copiedFull: "Resposta completa copiada",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markReady: "Pronto para revisão",
        markDoneAccessibility: "Marcar o workspace como concluído",
        markReadyAccessibility: "Marcar o workspace como pronto para revisão",
        pin: "Fixar no topo",
        unpin: "Desafixar",
        archive: "Arquivar",
