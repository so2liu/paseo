...
export const ar: TranslationResources = {
  ...
  message: {
    ...
    actions: {
      ...
      copyConclusion: "نسخ الخلاصة",
      copiedConclusion: "تم نسخ الخلاصة",
      copyFull: "نسخ الرد الكامل",
      copiedFull: "تم نسخ الرد الكامل",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markDoneAccessibility: "وضع مساحة العمل كمكتملة",
        markReadyAccessibility: "وضع مساحة العمل كجاهزة للمراجعة",
        pin: "تثبيت في الأعلى",
        unpin: "إلغاء التثبيت",
        archive: "أرشيف",
  ...
  desktop: {
    ...
    daemon: {
      ...
      versionSync: {
        managedHint:
          "هذا البرنامج الخفي من إصدار أقدم لسطح المكتب. قم بمزامنته وإعادة تشغيله بالإصدار المضمن في هذا التطبيق.",
        managedPausedHint: "فعّل إدارة البرنامج الخفي المضمن، ثم قم بالمزامنة وإعادة التشغيل.",
        externalHint:
          "تتم إدارة هذا البرنامج الخفي خارج تطبيق سطح المكتب. حدّث خدمة البرنامج الخفي الخارجية ثم أعد تشغيلها.",
        action: "مزامنة وإعادة تشغيل",
        syncing: "جارٍ المزامنة...",
        failed: "تعذرت مزامنة البرنامج الخفي: {{message}}",
        stillMismatched: "أُعيد تشغيل البرنامج الخفي لكنه لا يزال يبلغ عن إصدار مختلف.",
      },
