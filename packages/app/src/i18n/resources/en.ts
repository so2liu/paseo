export const en = {
  ...
  message: {
    ...
    actions: {
      ...
      copiedConclusion: "Copied conclusion",
      copyFull: "Copy full response",
      copiedFull: "Copied full response",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markReady: "Ready to review",
        markDoneAccessibility: "Mark workspace as done",
        markReadyAccessibility: "Mark workspace as ready to review",
        pin: "Pin to top",
        unpin: "Unpin",
        archive: "Archive",
