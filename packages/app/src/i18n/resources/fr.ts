...
export const fr: TranslationResources = {
  ...
  message: {
    actions: {
      ...
      copyConclusion: "Copier la conclusion",
      copiedConclusion: "Conclusion copiée",
      copyFull: "Copier la réponse complète",
      copiedFull: "Réponse complète copiée",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markReady: "Prêt à réviser",
        markDoneAccessibility: "Marquer l’espace de travail comme terminé",
        markReadyAccessibility: "Marquer l’espace de travail comme prêt à réviser",
