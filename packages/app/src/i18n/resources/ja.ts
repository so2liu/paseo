...
export const ja: TranslationResources = {
  ...
  message: {
    ...
    actions: {
      ...
      copyConclusion: "結論をコピー",
      copiedConclusion: "結論をコピーしました",
      copyFull: "全文をコピー",
      copiedFull: "全文をコピーしました",
      forkMenu: "メッセージをフォーク",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markDone: "完了にする",
        markReady: "レビュー待ちに戻す",
        markDoneAccessibility: "ワークスペースを完了にする",
        markReadyAccessibility: "ワークスペースをレビュー待ちに戻す",
        pin: "上部に固定",
        unpin: "固定解除",
        archive: "アーカイブ",
