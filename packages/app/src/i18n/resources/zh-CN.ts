...
export const zhCN: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        markDone: "标记为完成",
        markReady: "恢复为待审阅",
        markDoneAccessibility: "将 workspace 标记为完成",
        markReadyAccessibility: "将 workspace 恢复为待审阅",
        pin: "置顶",
        unpin: "取消置顶",
        archive: "归档",
  ...
  settings: {
    ...
    serverMigration: {
      ...
      copyAction: "复制",
      copied: "已复制",
      securityHint: "包含已保存的密码和配对密钥，请勿发送给他人。",
      importTitle: "批量导入服务器",
      importDescription: "与本机已有服务器合并，不会覆盖现有配置。",
      importHelp: "粘贴 Paseo 服务器 JSON，或每行一个 Relay 配对链接。",
      placeholder: "粘贴服务器 JSON 或 Relay 链接（每行一个）",
      importAction: "导入",
      importing: "正在导入...",
      invalid: "服务器数据无效",
    },
