...
// Fork: these line heights scale with the user's font size — a fixed 16 clips large text —
// while keeping 16 as the floor so the row reads the same at the default size.
const styles = StyleSheet.create((theme) => ({
  ...
  projectName: {
    ...
    lineHeight: Math.max(16, Math.round(theme.fontSize.sm * 1.2)),
    flexShrink: 1,
    minWidth: 0,
  },
  item: {
