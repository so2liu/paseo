...
| Agent reliability and models       | Idle agents remain warm for one hour; mixed-project push-token registration retries; Claude model probing preserves the catalog and correct context variants, including Opus 5; mobile thinking controls remain visible.                                                                                                      | `packages/server/src/server/bootstrap.ts`, push service, Claude provider/catalog code, agent controls                                                                     |
