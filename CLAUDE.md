...
| Fork engineering policy            | Agents fix reported bugs through verified PRs instead of stopping at diagnosis; syncs use release tags, preserve merge ancestry, and keep customization evidence; Windows CI remains intentionally disabled; browser E2E uses one cost-capped runner; Docker and Nix compatibility builds stay manual-only unless the owner explicitly re-enables automatic runs.                                                                                                                                                                         | `CLAUDE.md`, `docs/upstream-sync.md`, `.github/workflows/ci.yml`, `.github/workflows/docker.yml`, `.github/workflows/nix.yml`                                                                           |
